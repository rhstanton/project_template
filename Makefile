...
default:
	...
	@echo ""
	@echo "MAINTAINER:"
	@echo "  make bump-version VERSION=X.Y.Z  Set version everywhere + roll CHANGELOG"
	@echo ""
	@echo "HELP:"
...
help:
	...
	@echo "  make test             Run test suite (pytest, ~7 min)"
...
info:
	...
	@echo "  Primary:   Python 3.12 (pandas, matplotlib, pyyaml, pytest)"
