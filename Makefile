...
help:
	...
	@echo ""
	@echo "QUICK START:"
	@echo "  make environment      # One-time setup (~5-10 min)"
	...
	@echo "  make publish REQUIRE_CURRENT_HEAD=1  # Strict: require current HEAD"
	@echo ""
	@echo "EXAMPLES:"
	@echo "  make examples         # Run all example scripts (Python+Julia)"
	...
	@echo "  make sample-stata     # Run Stata example (if Stata installed)"
	@echo ""
	@echo "UTILITIES:"
	...
	@echo "  See QUICKSTART.md for 5-minute guide"
